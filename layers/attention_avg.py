...
def multiplicative_attention(queries, keys, values, bias, head_dim, positions, window_size, gernal_heads, local_heads, long_heads, keep_prob=None,
                             name=None):
...
def multihead_attention(queries, memories, bias, num_heads, key_size,
    ...
    with tf.variable_scope(scope, default_name="multihead_attention",
        ...
        # attention
        results = multiplicative_attention(q, k, v, bias, key_depth_per_head, positions, local_size, num_heads-local_heads-long_heads, local_heads, long_heads, keep_prob)
